...
namespace Persistence.Migrations
{
    ...
    [Migration("20220624182629_upadateCategoryEntity")]
    partial class upadateCategoryEntity
    {
            ...
            modelBuilder.Entity("Domain.Entites.Products.Brand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2022, 6, 24, 22, 56, 28, 883, DateTimeKind.Local).AddTicks(1833));
            ...
            modelBuilder.Entity("Domain.Entites.Products.Category", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 24, 22, 56, 28, 883, DateTimeKind.Local).AddTicks(3905));
            ...
            modelBuilder.Entity("Domain.Entites.Products.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 24, 22, 56, 28, 883, DateTimeKind.Local).AddTicks(6196));
            ...
            modelBuilder.Entity("Domain.Entites.Products.Feature", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 24, 22, 56, 28, 883, DateTimeKind.Local).AddTicks(7863));
            ...
            modelBuilder.Entity("Domain.Entites.Products.Image", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 24, 22, 56, 28, 883, DateTimeKind.Local).AddTicks(9591));
            ...
            modelBuilder.Entity("Domain.Entites.Products.Product", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 24, 22, 56, 28, 884, DateTimeKind.Local).AddTicks(1672));
            ...
            modelBuilder.Entity("Domain.Entites.Products.Tags", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 24, 22, 56, 28, 884, DateTimeKind.Local).AddTicks(4824));
