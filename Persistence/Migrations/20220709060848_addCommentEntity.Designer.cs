...
namespace Persistence.Migrations
{
    ...
    [Migration("20220709060848_addCommentEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entites.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2022, 7, 9, 10, 38, 48, 601, DateTimeKind.Local).AddTicks(1132));
            ...
            modelBuilder.Entity("Domain.Entites.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 9, 10, 38, 48, 601, DateTimeKind.Local).AddTicks(2716));
            ...
            modelBuilder.Entity("Domain.Entites.Comments.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 9, 10, 38, 48, 601, DateTimeKind.Local).AddTicks(4648));
                    ...
                    b.Property<int>("StatusOfComment")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entites.Customers.Address", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 9, 10, 38, 48, 601, DateTimeKind.Local).AddTicks(6480));
            ...
            modelBuilder.Entity("Domain.Entites.Orders.Order", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 9, 10, 38, 48, 601, DateTimeKind.Local).AddTicks(7709));
            ...
            modelBuilder.Entity("Domain.Entites.Orders.OrderItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 9, 10, 38, 48, 601, DateTimeKind.Local).AddTicks(9728));
            ...
            modelBuilder.Entity("Domain.Entites.Products.Brand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 9, 10, 38, 48, 602, DateTimeKind.Local).AddTicks(1652));
            ...
            modelBuilder.Entity("Domain.Entites.Products.Category", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 9, 10, 38, 48, 602, DateTimeKind.Local).AddTicks(3383));
            ...
            modelBuilder.Entity("Domain.Entites.Products.Favorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entites.Products.Feature", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 9, 10, 38, 48, 602, DateTimeKind.Local).AddTicks(7199));
            ...
            modelBuilder.Entity("Domain.Entites.Products.Image", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 9, 10, 38, 48, 603, DateTimeKind.Local).AddTicks(36));
            ...
            modelBuilder.Entity("Domain.Entites.Products.Product", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 9, 10, 38, 48, 603, DateTimeKind.Local).AddTicks(4011));
            ...
            modelBuilder.Entity("Domain.Entites.Products.Tags", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 9, 10, 38, 48, 603, DateTimeKind.Local).AddTicks(8259));
            ...
            modelBuilder.Entity("Domain.Entites.Comments.Comment", b =>
                {
                    b.HasOne("Domain.Entites.Comments.Comment", "ParentComment")
            ...
            modelBuilder.Entity("FavoriteProduct", b =>
                {
                    b.HasOne("Domain.Entites.Products.Favorite", null)
                        .WithMany()
